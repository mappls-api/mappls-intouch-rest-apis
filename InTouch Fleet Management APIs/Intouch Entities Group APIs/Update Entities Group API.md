...
> **Note:** Ensure the group exists before attempting an update. Use the [Fetch Entities Groups API](https://github.com/vandana-gupta8020/Intouch-APIs/blob/main/InTouch%20Fleet%20Management%20APIs/Intouch%20Entities%20Group%20APIs/Fetch%20Entities%20Groups%20API.md) and [Retrieve Basic Information of Device](https://github.com/vandana-gupta8020/Intouch-APIs/blob/main/InTouch%20Fleet%20Management%20APIs/Intouch%20Devices%20APIs/Retrieve%20Basic%20Information%20of%20Device%20API.md) API to obtain the corresponding `groupId` and `entityId`, respectively.
