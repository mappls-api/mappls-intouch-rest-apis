...
> **Note:** Ensure the trip exists before invoking this API. You can use the [Trips Retrieval API](https://github.com/vandana-gupta8020/Intouch-APIs/blob/main/InTouch%20Fleet%20Management%20APIs/Intouch%20Trip%20APIs/Trips%20Retrieval%20API.md) to list all trips and obtain the corresponding tripId.
